...
module.exports = async function transformer({
    ...
    for (let bundle of bundles) {
        ...
        const bundleExists = await fs.pathExistsSync(bundleFile);
        const bundleMapExists = await fs.pathExistsSync(bundleSourceMap);
