...
module.exports = function resolve(pattern, {
    ...
    const startsWithExtensionPattern = new RegExp(`^${targetExtension}/`);
    const containsExtensionPattern = new RegExp(`/${targetExtension}/`);
    ...
    const filePattern = aliasedPattern.replace(startsWithExtensionPattern, '');
            ...
            return resolve(
                matches
                    ...
                    .map( file => {
                        ...
                        if(extensionPrefix && !startsWithExtensionPattern.test(file) && !containsExtensionPattern.test(file)){
